...
public class OggettoCorriereController implements Controller  {
	
private static String sub_package = "oggetto.";
	
	private OggettoService oggettoService;
	
	public OggettoCorriereController() {
	...
	public void doControl(Request request) {
		...
		case "OGGETTOLIST":
			...
			MainDispatcher.getInstance().callView(sub_package + "OggettoCorriereDelete", request);
			break;
		}
